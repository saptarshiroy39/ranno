...
export default function Page() {
  return (
    <article className="space-y-6 font-mono">
      ...
      <CodeBlockRenderer language="bash" title="pip" code="pip install ranno" />
      ...
      <CodeBlockRenderer language="bash" title="uv" code="uv add ranno" />
